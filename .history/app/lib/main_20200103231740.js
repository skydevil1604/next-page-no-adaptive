...
function showTarget(targets, targetId) {
    ...
    var currentTargetNodeId = extractId(targetNode, TARGET_CLASS_NAME);
		if (currentTargetNodeId === targetId) {
			targetNode.classList.remove(HIDDEN_CLASS_NAME).add('active');
		} else {
			targetNode.classList.add(HIDDEN_CLASS_NAME).remove('active');
		}
	});
}
...
$("#first-works-image")
    .mouseover(function() {
        this.src = this.src.replace('img/gear_dark copy.svg', 'img/gear_red.svg');
})
.mouseout(function() {
        this.src = this.src.replace('img/gear_red.svg', 'img/gear_dark copy.svg');
});
