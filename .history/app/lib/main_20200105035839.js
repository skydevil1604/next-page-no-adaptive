...
// var slidesPics = $('.slide-pic'),    //массив слайдов
// slidesPicsCount = slidesPics.length; //количество слайдов
// i = 0;  //текущий слайд
    
// //начальный порядок слайдов
// slidesPics.each(function(z){
...
//     if(i == slidesPicsCount) i = 0;
        
//     //выбрать текущий и удалить его через 300мс
//     slidesPics.eq(i).fadeOut(300, function(){
        
//         //после чего сменить все индексы
//         slidesPics.each(function(j){
//             $(this).css('z-index', ((slidesPicsCount - j)+i) % slidesPicsCount);
//         });
//         //и увеличить счетчик
//         i++;
...
// }  
 ...
 var image_ID = new Array("images/headphones.svg", "images/cinema.svg", "images/star_big.svg");
